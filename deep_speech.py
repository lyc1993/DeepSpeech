...
def define_deep_speech_flags():
  ...
  flags_core.set_defaults(
      model_dir="/home/liu477/deep_speech_model/",
      export_dir="/home/liu477/deep_speech_saved_model/",
      train_epochs=10,
      batch_size=128,
      hooks="")
  ...
  flags.DEFINE_string(
      name="train_data_dir",
      default="/data/liu477/librispeech_data/test-clean/LibriSpeech/test-clean.csv",
